...
def main():
    ...
    #parser.add_argument('-c', '--com_port', type=str, default='usb-1a86_default-if00-port0', help='COM port of 1st scanner. Defaults to COM8')
    parser.add_argument('-c', '--com_port', type=str, default='/dev/ttyUSB0', help='COM port of 1st scanner. Defaults to COM8')
