...
def main():
    ...
    parser.add_argument('-c', '--com_port', type=str, default='COM8', help='COM port of 1st scanner. Defaults to COM8')
    parser.add_argument('-c2', '--com_port2', type=str, default='COM9', help='COM port of 2nd scanner. Defaults to COM9')
